...
export default function NFTMintPage() {
  ...
  <p className={`text-lg font-medium ${
    theme === "light" ? "text-gray-700" : "text-bright-aqua"
                  ...
                  <div className="text-center space-y-6">
                    <div className="relative inline-block">
                      ...
                      <div className="absolute top-4 left-4">
                        <Badge className={`${
                          theme === "light" 
                            ? "bg-white/90 text-violet-indigo border border-violet-indigo/30 font-semibold" 
                      ...
                      <Button
                        ...
                        className={`w-full ${
                          theme === "light"
                            ...
                            : "cyber-button pulse-glow bg-gradient-to-r from-violet-indigo to-bright-aqua hover:from-violet-indigo/90 hover:to-bright-aqua/90 text-white"
                        }`}
                      >
  ...
  <h1 className={`text-4xl md:text-5xl font-bold bg-gradient-to-r bg-clip-text text-transparent mb-4 pb-2 ${
    theme === "light" 
      ? "from-bright-aqua to-violet-indigo" 
      : "from-bright-aqua to-white drop-shadow-[0_0_30px_rgba(0,255,255,0.5)]"
  }`}>
    Mint Your Origin NFT
  </h1>
  <p className={`text-lg font-medium ${
    theme === "light" ? "text-bright-aqua" : "text-bright-aqua"
  }`}>
              ...
              <Card className={`max-w-2xl mx-auto ${
                ...
                <CardContent className="space-y-6">
                  ...
                  <Button
                    ...
                    className={`w-full ${
                      theme === "light"
                        ? "bg-gradient-to-r from-violet-indigo to-bright-aqua hover:from-violet-indigo/90 hover:to-bright-aqua/90 text-white font-semibold"
                        : "cyber-button pulse-glow bg-gradient-to-r from-violet-indigo to-bright-aqua hover:from-violet-indigo/90 hover:to-bright-aqua/90 text-white"
                    }`}
                  >
                    {isGenerating ? (
