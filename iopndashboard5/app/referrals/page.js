...
export default function ReferralsPage() {
  ...
  const totalEarned = referrals.reduce((sum, ref) => sum + ref.repEarned, 0)
  ...
  <p className={`text-lg font-semibold bg-gradient-to-r bg-clip-text text-transparent ${
    ...
    Invite friends to join IOPn and earn rewards together.
              ...
              {/* Referral Stats - Enhanced Light Mode Colors */}
    ...
    : "holo-card card-hover bg-gradient-to-br from-black/80 to-midnight-indigo/30 neon-border"
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className={`text-sm font-semibold ${
                          theme === "light" ? "text-white" : "text-green-500"
                        }`}>
                          Active Users
                        </p>
                        <p className={`text-2xl font-bold ${
                      ...
                      <UserPlus className={`w-8 h-8 ${
                        theme === "light" ? "text-white" : "text-green-500 drop-shadow-[0_0_10px_rgba(34,197,94,0.5)]"
                      }`} />
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Star className={`w-8 h-8 ${
                        theme === "light" ? "text-white" : "text-yellow-500 drop-shadow-[0_0_10px_rgba(234,179,8,0.5)]"
                      }`} />
                    </div>
                  </CardContent>
                </Card>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card className={`${
                  ...
                  <CardContent className="space-y-6">
                    ...
                    {/* Rewards Info - Enhanced Light Mode */}
