                ...
                <Card className={`${
                  ...
                  <CardHeader className="pb-3">
                    <CardTitle className={`flex items-center space-x-2 text-lg ${
                      ...
                      <Star className="w-4 h-4 text-violet-indigo drop-shadow-[0_0_10px_rgba(139,0,255,0.5)]" />
                    ...
                    <CardDescription className={`text-xs ${theme === "light" ? "text-gray-600" : "text-bright-aqua/70 font-medium"}`}>
                      Origin Genesis #{userNFT.name?.match(/\d+/)?.[0] || "1976"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div 
                      ref={nftContainerRef}
                      className="relative rounded-lg overflow-hidden bg-black aspect-square mb-4"
                    ...
                    >
                      ...
                      <div className="absolute top-2 left-2">
                        <Badge className="bg-black/50 text-white border-0 text-xs">IOPn</Badge>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <div className="flex gap-1 mt-1">
                            <Badge className="bg-violet-indigo text-white text-xs px-1.5 py-0">Special</Badge>
                            <Badge className="bg-bright-aqua text-black text-xs px-1.5 py-0">Rare</Badge>
                          </div>
                        </div>
                      </div>
                    </div>
