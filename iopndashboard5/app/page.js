...
const handleDiscordComplete = () => {
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset>
        {/* REMOVED hex-pattern class - keep cyber-grid if you want the grid lines */}
                      ...
                      <div
                        ...
                        className={`flex items-center justify-between p-2 sm:p-3 rounded-lg shadow-sm transition-all duration-300 ${
                          theme === "light"
                            ...
                            : "40 border border-bright-aqua/20 holo-card"
                        }`}
                      >
            ...
            try {
              ...
              if (response.ok) {
                ...
                if (convertDirection === "toOnChain") {
                  // Update your states here based on conversion
                }
