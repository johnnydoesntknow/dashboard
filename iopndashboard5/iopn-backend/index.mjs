...
// NEW: Mint NFT Endpoint with Sequential IDs
// In your backend file, update the /api/nft/mint endpoint:
...
// Start server - THIS SHOULD BE AT THE VERY BOTTOM, OUTSIDE ALL ROUTES
app.listen(PORT, () => {
