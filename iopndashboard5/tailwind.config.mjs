...
export default {
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom IOPn colors
        "bright-aqua": "#b0efff",        // Softer cyan from brand
  ...
  "midnight-indigo": "#1d2449",    // Dark blue from brand
  "brand-dark": "#0f112a",         // Darkest brand color
  "brand-light-text": "#f8fdf1",   // Off-white for text
  "brand-gray": "#4f5262",         // Gray for muted text
      ...
      keyframes: {
        ...
        "tutorial-pulse": {
          "0%, 100%": {
            boxShadow: "0 0 0 4px rgba(0, 255, 255, 0.5)",
          },
          "50%": {
            boxShadow: "0 0 0 8px rgba(0, 255, 255, 0.3)",
          },
        },
      },
      animation: {
